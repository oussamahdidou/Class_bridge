...
(7, 'Algorithmique et Complexite', 'le projet se base sur la creation d`un algorithme de gestion sur une entreprise de livraison ', 28, '../New_folder/projects/RAPPORT CA.pdf', 0);
COMMIT;
